...
The two original entry files (`app_course_generator.py` /
`app_claims_lesson.py`) are still runnable standalone if you prefer
one-app-at-a-time. They detect unified mode via
`st.session_state["_advice_unified_mode"]` and skip their own page-config
and CSS injection in that case.
"""
...
from shared.carbon import inject_carbon_css, topbar, hero, _html_escape  # noqa: E402
...
# ---------------------------------------------------------------------------
import app_course_generator as course_app  # noqa: E402
import app_claims_lesson as claims_app     # noqa: E402
