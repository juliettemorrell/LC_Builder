...
from shared.snowflake_client import get_risk_driver_stats
...
from shared.photos import (list_photos, get_photo, add_uploaded_photo,
...
def _append_topic_lesson(topic: str):
    ...
    from shared.prompts import build_embedded_lesson_for_topic
